...
class Broker:
    def __init__(self,
        ...
        if logger is not None:
            ...
            self.precise_stops = precise_stops
            ...
            if not self._get_range(self.dates[self.current_dt_i], half=True)[0].year == self.dates[
                self.current_dt_i].year:
